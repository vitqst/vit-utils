...
- Generate RFC 4122 UUID v4 values with version/variant bits set.
...
ULIDs reveal their creation timestamp. Identifiers are generated locally and are
not registered with any external service.
